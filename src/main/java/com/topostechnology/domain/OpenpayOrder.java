...
@Entity
@Table(name = "openpay_order")
@Getter
@Setter
public class OpenpayOrder extends CoreCatalogEntity {
	...
	@Column(name = "order_id", nullable = false, length = 300)
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OpenpayOrder)) return false;
        OpenpayOrder user = (OpenpayOrder) o;
